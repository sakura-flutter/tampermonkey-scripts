...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/scripts/widescreen/index.scss
var widescreen = __webpack_require__(7667);
// CONCATENATED MODULE: ./src/scripts/widescreen/index.scss
;
            

var widescreen_options = {};

widescreen_options.insert = "head";
widescreen_options.singleton = false;

var widescreen_update = injectStylesIntoStyleTag_default()(widescreen/* default */.Z, widescreen_options);



/* harmony default export */ const scripts_widescreen = (widescreen/* default.locals */.Z.locals || {});
...
handlers.set('bcy', function () {
  const store = widescreen_createStore('bcy');
...
handlers.set('mpWeixin', function () {
  const store = widescreen_createStore('mpWeixin');
...
handlers.set('zhihu', function () {
  const store = widescreen_createStore('zhihu');
...
handlers.set('juejin', function () {
  const store = widescreen_createStore('juejin');
...
handlers.set('jianshu', function () {
  const store = widescreen_createStore('jianshu');
...
handlers.set('baidu', function () {
  const store = widescreen_createStore('baidu');
...
handlers.set('tieba', function () {
  const store = widescreen_createStore('tieba');
...
handlers.set('sogou', function () {
  const store = widescreen_createStore('sogou');
...
handlers.set('segmentfault', function () {
  const store = widescreen_createStore('segmentfault');
...
handlers.set('bilibili', function () {
  const store = widescreen_createStore('bilibili');
...
handlers.set('weibo', function () {
  const store = widescreen_createStore('weibo');
...
handlers.set('doubanmovie', function () {
  const store = widescreen_createStore('doubanmovie');
...
handlers.set('toutiao', function () {
  const store = widescreen_createStore('toutiao');
  const call = once(() => {
    createWidescreenControl({
      store,
      execute
...
function widescreen_createStore(sitename) {
  ...
  const store = new Proxy(createStore(sitename), handler);
  return store;
