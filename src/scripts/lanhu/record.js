              ...
              >
                {reversed.value.map((item, index) => (
                  <li
                    ...
                    key={item.pid}
                    ref={el => { el && (lisRef.value[index] = el) }}
                  >
                    <a
                      href={item.href}
